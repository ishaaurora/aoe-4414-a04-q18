...
if len(sys.argv) == 10:
    try:
        ...
        print("Error: year month day hour minute second eci_x_km eci_y_km, and eci_z_km must be numeric.")
        exit()
else:
    print(\
...
#to ecef
ecef_x_km = eci_x_km*math.cos(-rad_GMST) - eci_y_km*math.sin(-rad_GMST)
ecef_y_km = eci_x_km*math.sin(-rad_GMST) + eci_y_km*math.cos(-rad_GMST)
ecef_z_km = eci_z_km
